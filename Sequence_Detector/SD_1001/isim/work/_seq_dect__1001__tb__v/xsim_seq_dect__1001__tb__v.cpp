...
va_list vap)
{
    extern HSim__s6 * createworkM_seq_dect__1001__tb__v(const char*);
    HSim__s6 *blk = createworkM_seq_dect__1001__tb__v(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createworkM_seq_dect__1001(const char*);
    HSim__s6 *blk = createworkM_seq_dect__1001(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","SeqDect_1001_tb_v", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("work","SeqDect_1001", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("work","glbl", (HSimInstFactoryPtr)IF2);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkM_seq_dect__1001__tb__v(const char*);
        topvl = (HSim__s5*)createworkM_seq_dect__1001__tb__v("SeqDect_1001_tb_v");
