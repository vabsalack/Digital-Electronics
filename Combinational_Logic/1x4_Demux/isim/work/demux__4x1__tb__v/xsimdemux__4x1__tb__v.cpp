...
va_list vap)
{
    extern HSim__s6 * createworkMdemux__4x1__tb__v(const char*);
    HSim__s6 *blk = createworkMdemux__4x1__tb__v(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createworkM_demun__4x1(const char*);
    HSim__s6 *blk = createworkM_demun__4x1(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","demux_4x1_tb_v", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("work","Demun_4x1", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("work","glbl", (HSimInstFactoryPtr)IF2);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMdemux__4x1__tb__v(const char*);
        topvl = (HSim__s5*)createworkMdemux__4x1__tb__v("demux_4x1_tb_v");
