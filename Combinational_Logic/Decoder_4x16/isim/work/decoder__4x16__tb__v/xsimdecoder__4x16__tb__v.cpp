...
va_list vap)
{
    extern HSim__s6 * createworkMdecoder__4x16__tb__v(const char*);
    HSim__s6 *blk = createworkMdecoder__4x16__tb__v(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createworkMdeocder__4x16(const char*);
    HSim__s6 *blk = createworkMdeocder__4x16(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","decoder_4x16_tb_v", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("work","deocder_4x16", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("work","glbl", (HSimInstFactoryPtr)IF2);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMdecoder__4x16__tb__v(const char*);
        topvl = (HSim__s5*)createworkMdecoder__4x16__tb__v("decoder_4x16_tb_v");
